...
public class BankTest extends Assert {
    ...
    public void statelessBankEJB() throws Exception {
        final StatelessBank bank = (StatelessBank) _ejbContainer.getContext().lookup(
                "java:global/local-bean/StatelessBankOwnImpl" //        	"java:global/local-bean/StatelessBankDelegatingImpl"
                );
...
//        bank.kontoAufloesen("Thomas");
//        try {
//            assertEquals("bank.kontoAufloesen()", null, bank.kontoAufloesen("Thomas"));
